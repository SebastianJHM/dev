...
var SIGMA{C},binary;              /*Si se activa la restricción asociada a la ciudad c in C*/
...
/*RESTRICCIONES*/
/*Cada almacén puede enviar máximo 120 unidades*/
...
/*Codificación de restricciones y variables disyuntivas*/
/*La cantidad máxima enviada de una ciudad a elegir es de 70 unidades*/
s.t. res7{c in C}: sum{r in R}y[c,r]<=70+10000*(1-SIGMA[c]);
/*Se debe cumplir sólo para una ciudad*/
s.t. res8: sum{c in C}SIGMA[c] = 1;
/*Si el almacén de una ciudad no se abre, no se tiene en cuenta para la restricción de las 70 unidades*/
...
printf: "\        ------------------------ \n";
printf: "\nCIUDAD QUE PUEDE ENVIAR MÁXIMO 70: ";
