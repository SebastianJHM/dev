...
var z{C,R},binary >= 0;           /*1 Si envía producto del almaceén de la ciudad c in C.0 dlc*/
var w{C,R};                       /*y[c,r] si se envía de c in C a r in R. M si no se envía*/
var minimo_enviado;               /*Mínimo valor enviado entre todas las ciudades y todas las regiones*/
...
/*Codificación de w[c,r]: y[c,r] si se envía de c in C a r in R. M si no se envía*/
/*Aclaración: para la restricción 11 y 12 se usan dos valores distintos como gran M. El primero es de 100, que es valor que tomará w si si z[c,r]=0. La razón de este valor es porque es mayor a toda demanda. El segundo valor de gran M es 1000, que serán los valores de cota superior e inferior cuando z[c,r]=1. Es importante que M1 < M2, teniendo en cuenta las utilidades que tienen en las restricciones*/
...
/*Codificación de minimo_enviado: menor que todos los valores de w[c,r]. De esta forma, como se está mínimo enviado, se hace exactamente igual*/
...
printf: "\        ------------------------ \n";
printf: "\nMÍNIMA CANTIDAD ENVIADA: "&round(minimo_enviado)&"\n";
printf: "------------------------\n";
printf: "\nCOSTOS:\n";
